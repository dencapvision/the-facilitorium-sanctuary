...
import { Play, PenTool, Users, Sparkles, Globe, ShieldCheck, Zap } from 'lucide-react';
          ...
          <div className="lg:col-span-8 space-y-16 relative z-10">
            ...
            <section className="space-y-8 animate-fade-in text-center lg:text-left">
              <div className="group relative w-full h-[400px] rounded-[2.5rem] overflow-hidden shadow-premium mb-10 border-4 border-white">
                <img 
                  ...
                  alt="The Facilitorium — โรงเรียนวิทยากรผู้สร้างการเปลี่ยนแปลง" 
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4 justify-center lg:justify-start">
                  ...
                  <Link href="/lms" className="px-8 py-4 bg-white border border-royal-blue/10 text-royal-blue font-bold rounded-2xl hover:bg-royal-blue/5 transition-all">
                    เรียนรู้เพิ่มเติม
                  </Link>
                </div>
              </div>
            ...
            <section className="space-y-10">
               <div className="flex items-end justify-between border-b border-royal-blue/5 pb-6">
                 ...
                 <Link href="/lms" className="text-gold font-bold text-sm flex items-center gap-2 hover:gap-3 transition-all">
